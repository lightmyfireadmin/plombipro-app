...
DROP TRIGGER IF EXISTS update_purchases_modtime ON purchases;
DROP TRIGGER IF EXISTS update_job_sites_modtime ON job_sites;
DROP TRIGGER IF EXISTS update_job_site_notes_modtime ON job_site_notes;
DROP TRIGGER IF EXISTS update_settings_modtime ON settings;
DROP TRIGGER IF EXISTS update_stripe_subscriptions_modtime ON stripe_subscriptions;
DROP TRIGGER IF EXISTS update_product_usage_quotes ON quotes;
DROP TRIGGER IF EXISTS update_product_usage_invoices ON invoices;
