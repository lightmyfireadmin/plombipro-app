  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        "Scan universel (tous documents)",
        "Catalogues 10 fournisseurs (50 000+ articles)",
        "50 devis types plomberie + GPS auto",
        "Gestion multi-chantiers + employés",
        "Suivi CA, marges, taxes en temps réel",
        "Relances automatiques SMS/Email",
        "Export comptable + prévisions",
        "Conforme Factur-X 2026 (Chorus Pro)",
