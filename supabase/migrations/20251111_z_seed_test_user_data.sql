...
INSERT INTO products (
  ...
  price_buy, price_sell, purchase_price_ht, selling_price_ht,
  vat_rate, supplier, category, is_favorite,
  created_at
) VALUES
('30000000-0000-0000-0002-000000000001', test_user_id, 'Mitigeur lavabo chromé', 'ROB-MIT-001',
 ...
 45.90, 125.00, 45.90, 125.00, 20.0, 'Grohe', 'Robinetterie', true,
 NOW() - INTERVAL '2 years'),
('30000000-0000-0000-0002-000000000002', test_user_id, 'Mitigeur douche thermostatique', 'ROB-MIT-002',
 ...
 89.50, 245.00, 89.50, 245.00, 20.0, 'Grohe', 'Robinetterie', true,
 NOW() - INTERVAL '1 year'),
('30000000-0000-0000-0002-000000000003', test_user_id, 'Robinet cuisine douchette', 'ROB-CUI-001',
 ...
 67.00, 189.00, 67.00, 189.00, 20.0, 'Hansgrohe', 'Robinetterie', false,
 NOW() - INTERVAL '1 year'),
('30000000-0000-0000-0002-000000000004', test_user_id, 'WC suspendu compact', 'SAN-WC-001',
 ...
 145.00, 395.00, 145.00, 395.00, 20.0, 'Geberit', 'Sanitaires', true,
 NOW() - INTERVAL '6 months'),
('30000000-0000-0000-0002-000000000005', test_user_id, 'Lavabo céramique 60cm', 'SAN-LAV-001',
 ...
 56.00, 159.00, 56.00, 159.00, 20.0, 'Roca', 'Sanitaires', false,
 NOW() - INTERVAL '1 year'),
('30000000-0000-0000-0002-000000000006', test_user_id, 'Baignoire acrylique 170cm', 'SAN-BAI-001',
 ...
 234.00, 650.00, 234.00, 650.00, 20.0, 'Jacob Delafon', 'Sanitaires', false,
 NOW() - INTERVAL '8 months'),
...
('30000000-0000-0000-0002-000000000010', test_user_id, 'Tube cuivre écroui Ø14mm', 'TUY-CUI-014',
 ...
 3.20, 8.50, 3.20, 8.50, 20.0, 'Comap', 'Tuyauterie', false,
 NOW() - INTERVAL '3 years'),
('30000000-0000-0000-0002-000000000011', test_user_id, 'Multicouche Ø16mm', 'TUY-MUL-016',
 ...
 0.75, 2.00, 0.75, 2.00, 20.0, 'Henco', 'Tuyauterie', true,
 NOW() - INTERVAL '1 year'),
('30000000-0000-0000-0002-000000000012', test_user_id, 'Raccord PER à compression', 'RAC-PER-001',
 ...
 12.50, 34.00, 12.50, 34.00, 20.0, 'Comap', 'Raccords', true,
 NOW() - INTERVAL '1 year'),
('30000000-0000-0000-0002-000000000013', test_user_id, 'Té égal laiton 15/21', 'RAC-TEE-001',
 ...
 1.20, 3.50, 1.20, 3.50, 20.0, 'Boutte', 'Raccords', false,
 NOW() - INTERVAL '2 years'),
('30000000-0000-0000-0002-000000000014', test_user_id, 'Coude à sertir cuivre 90°', 'RAC-COU-001',
 ...
 2.30, 6.50, 2.30, 6.50, 20.0, 'Comap', 'Raccords', false,
 NOW() - INTERVAL '1 year'),
('30000000-0000-0000-0002-000000000015', test_user_id, 'Radiateur aluminium 600mm', 'CHA-RAD-001',
 ...
 89.00, 245.00, 89.00, 245.00, 20.0, 'Acova', 'Chauffage', true,
 NOW() - INTERVAL '1 year'),
('30000000-0000-0000-0002-000000000016', test_user_id, 'Vanne thermostatique radiateur', 'CHA-VAN-001',
 ...
 23.00, 65.00, 23.00, 65.00, 20.0, 'Danfoss', 'Chauffage', true,
 NOW() - INTERVAL '6 months'),
('30000000-0000-0000-0002-000000000017', test_user_id, 'Collecteur chauffage sol 8 circuits', 'CHA-COL-001',
 ...
 156.00, 425.00, 156.00, 425.00, 20.0, 'Oventrop', 'Chauffage', false,
 NOW() - INTERVAL '8 months'),
('30000000-0000-0000-0002-000000000018', test_user_id, 'Pâte à joint pot 500g', 'OUT-PAT-001',
 ...
 8.50, 22.00, 8.50, 22.00, 20.0, 'Gebatout', 'Consommables', true,
 NOW() - INTERVAL '3 years'),
('30000000-0000-0000-0002-000000000019', test_user_id, 'Téflon rouleau professionnel', 'OUT-TEF-001',
 ...
 4.20, 11.50, 4.20, 11.50, 20.0, 'Guilbert', 'Consommables', true,
 NOW() - INTERVAL '3 years'),
('30000000-0000-0000-0002-000000000020', test_user_id, 'Silicone sanitaire blanc', 'OUT-SIL-001',
 ...
 3.80, 10.50, 3.80, 10.50, 20.0, 'Rubson', 'Consommables', true,
 NOW() - INTERVAL '2 years')
ON CONFLICT (id) DO UPDATE SET
...
('40000000-0000-0000-0003-000000000002', test_user_id, client_02, 'DEV-2025-0002',
 ...
 8900.00, 8900.00, 1780.00, 1780.00, 10680.00,
...
('40000000-0000-0000-0003-000000000003', test_user_id, client_03, 'DEV-2025-0003',
 ...
 450.00, 450.00, 90.00, 90.00, 540.00,
...
('40000000-0000-0000-0003-000000000004', test_user_id, client_04, 'DEV-2025-0004',
 ...
 780.00, 780.00, 156.00, 156.00, 936.00,
...
('40000000-0000-0000-0003-000000000005', test_user_id, client_05, 'DEV-2025-0005',
 ...
 2100.00, 2100.00, 420.00, 420.00, 2520.00,
...
('40000000-0000-0000-0003-000000000006', test_user_id, client_06, 'DEV-2025-0006',
 ...
 1650.00, 1650.00, 330.00, 330.00, 1980.00,
...
('40000000-0000-0000-0003-000000000007', test_user_id, client_07, 'DEV-2025-0007',
 ...
 4200.00, 4200.00, 840.00, 840.00, 5040.00,
...
('40000000-0000-0000-0003-000000000008', test_user_id, client_08, 'DEV-2025-0008',
 ...
 590.00, 590.00, 118.00, 118.00, 708.00,
...
('40000000-0000-0000-0003-000000000009', test_user_id, client_09, 'DEV-2025-0009',
 ...
 320.00, 320.00, 64.00, 64.00, 384.00,
...
('40000000-0000-0000-0003-000000000010', test_user_id, client_10, 'DEV-2025-0010',
 ...
 3100.00, 3100.00, 620.00, 620.00, 3720.00,
...
('40000000-0000-0000-0003-000000000011', test_user_id, client_11, 'DEV-2025-0011',
 ...
 5600.00, 5600.00, 1120.00, 1120.00, 6720.00,
...
('40000000-0000-0000-0003-000000000012', test_user_id, client_12, 'DEV-2025-0012',
 ...
 890.00, 890.00, 178.00, 178.00, 1068.00,
...
INSERT INTO invoices (
  id, user_id, client_id, number, invoice_number,
  date, invoice_date, due_date, payment_date, status, payment_method,
  subtotal_ht, tva_amount, total_vat, total_ttc,
  amount_paid, payment_status,
  notes, legal_mentions,
  created_at, updated_at
) VALUES
('50000000-0000-0000-0004-000000000001', test_user_id, client_01, 'FACT-2025-0001', 'FACT-2025-0001',
 (NOW() - INTERVAL '27 days')::date, (NOW() - INTERVAL '27 days')::date, (NOW() + INTERVAL '3 days')::date,
 (NOW() - INTERVAL '25 days')::date, 'paid', 'bank_transfer',
 2275.00, 455.00, 455.00, 2730.00, 2730.00, 'paid',
...
('50000000-0000-0000-0004-000000000002', test_user_id, client_02, 'FACT-2025-0002', 'FACT-2025-0002',
 (NOW() - INTERVAL '24 days')::date, (NOW() - INTERVAL '24 days')::date, (NOW() + INTERVAL '6 days')::date,
 (NOW() - INTERVAL '20 days')::date, 'paid', 'check',
 450.00, 90.00, 90.00, 540.00, 540.00, 'paid',
 'Remplacement robinetterie',
 'En cas de retard de paiement, seront exigibles, conformément à l''article L 441-10 du code de commerce, une indemnité calculée sur la base de trois fois le taux de l''intérêt légal en vigueur ainsi qu''une indemnité forfaitaire pour frais de recouvrement de 40 euros. SIRET: 85234567800012 - TVA: FR85234567800 - RCS Paris',
 NOW() - INTERVAL '27 days', NOW() - INTERVAL '26 days'),
('50000000-0000-0000-0004-000000000003', test_user_id, client_03, 'FACT-2025-0003', 'FACT-2025-0003',
 (NOW() - INTERVAL '21 days')::date, (NOW() - INTERVAL '21 days')::date, (NOW() + INTERVAL '9 days')::date,
 (NOW() - INTERVAL '28 days')::date, 'paid', 'cash',
 320.00, 64.00, 64.00, 384.00, 384.00, 'paid',
 'Dépannage urgent',
 'En cas de retard de paiement, seront exigibles, conformément à l''article L 441-10 du code de commerce, une indemnité calculée sur la base de trois fois le taux de l''intérêt légal en vigueur ainsi qu''une indemnité forfaitaire pour frais de recouvrement de 40 euros. SIRET: 85234567800012 - TVA: FR85234567800 - RCS Paris',
 NOW() - INTERVAL '24 days', NOW() - INTERVAL '23 days'),
('50000000-0000-0000-0004-000000000004', test_user_id, client_04, 'FACT-2025-0004', 'FACT-2025-0004',
 (NOW() - INTERVAL '18 days')::date, (NOW() - INTERVAL '18 days')::date, (NOW() + INTERVAL '12 days')::date,
 NULL, 'sent', NULL,
 2670.00, 534.00, 534.00, 3204.00, 0.00, 'unpaid',
 'Installation chauffage - Acompte de 30%',
 'En cas de retard de paiement, seront exigibles, conformément à l''article L 441-10 du code de commerce, une indemnité calculée sur la base de trois fois le taux de l''intérêt légal en vigueur ainsi qu''une indemnité forfaitaire pour frais de recouvrement de 40 euros. SIRET: 85234567800012 - TVA: FR85234567800 - RCS Paris',
 NOW() - INTERVAL '21 days', NOW() - INTERVAL '20 days'),
('50000000-0000-0000-0004-000000000005', test_user_id, client_05, 'FACT-2025-0005', 'FACT-2025-0005',
 (NOW() - INTERVAL '15 days')::date, (NOW() - INTERVAL '15 days')::date, (NOW() + INTERVAL '15 days')::date,
 (NOW() - INTERVAL '15 days')::date, 'paid', 'bank_transfer',
 2940.00, 588.00, 588.00, 3528.00, 3528.00, 'paid',
 'Création salle d''eau - Solde',
 'En cas de retard de paiement, seront exigibles, conformément à l''article L 441-10 du code de commerce, une indemnité calculée sur la base de trois fois le taux de l''intérêt légal en vigueur ainsi qu''une indemnité forfaitaire pour frais de recouvrement de 40 euros. SIRET: 85234567800012 - TVA: FR85234567800 - RCS Paris',
 NOW() - INTERVAL '18 days', NOW() - INTERVAL '17 days'),
('50000000-0000-0000-0004-000000000006', test_user_id, client_06, 'FACT-2025-0006', 'FACT-2025-0006',
 (NOW() - INTERVAL '12 days')::date, (NOW() - INTERVAL '12 days')::date, (NOW() + INTERVAL '18 days')::date,
 (NOW() - INTERVAL '10 days')::date, 'paid', 'card',
 590.00, 118.00, 118.00, 708.00, 708.00, 'paid',
 'Maintenance annuelle',
 'En cas de retard de paiement, seront exigibles, conformément à l''article L 441-10 du code de commerce, une indemnité calculée sur la base de trois fois le taux de l''intérêt légal en vigueur ainsi qu''une indemnité forfaitaire pour frais de recouvrement de 40 euros. SIRET: 85234567800012 - TVA: FR85234567800 - RCS Paris',
 NOW() - INTERVAL '15 days', NOW() - INTERVAL '14 days'),
('50000000-0000-0000-0004-000000000007', test_user_id, client_07, 'FACT-2025-0007', 'FACT-2025-0007',
 (NOW() - INTERVAL '9 days')::date, (NOW() - INTERVAL '9 days')::date, (NOW() + INTERVAL '21 days')::date,
 NULL, 'overdue', NULL,
 780.00, 156.00, 156.00, 936.00, 0.00, 'overdue',
 'Réparation fuite - Facture en retard, relance envoyée',
 'En cas de retard de paiement, seront exigibles, conformément à l''article L 441-10 du code de commerce, une indemnité calculée sur la base de trois fois le taux de l''intérêt légal en vigueur ainsi qu''une indemnité forfaitaire pour frais de recouvrement de 40 euros. SIRET: 85234567800012 - TVA: FR85234567800 - RCS Paris',
 NOW() - INTERVAL '12 days', NOW() - INTERVAL '11 days'),
('50000000-0000-0000-0004-000000000008', test_user_id, client_08, 'FACT-2025-0008', 'FACT-2025-0008',
 (NOW() - INTERVAL '6 days')::date, (NOW() - INTERVAL '6 days')::date, (NOW() + INTERVAL '24 days')::date,
 NULL, 'draft', NULL,
 930.00, 186.00, 186.00, 1116.00, 0.00, 'unpaid',
 'Installation radiateurs - Acompte',
 'En cas de retard de paiement, seront exigibles, conformément à l''article L 441-10 du code de commerce, une indemnité calculée sur la base de trois fois le taux de l''intérêt légal en vigueur ainsi qu''une indemnité forfaitaire pour frais de recouvrement de 40 euros. SIRET: 85234567800012 - TVA: FR85234567800 - RCS Paris',
 NOW() - INTERVAL '9 days', NOW() - INTERVAL '8 days'),
('50000000-0000-0000-0004-000000000009', test_user_id, client_09, 'FACT-2025-0009', 'FACT-2025-0009',
 (NOW() - INTERVAL '3 days')::date, (NOW() - INTERVAL '3 days')::date, (NOW() + INTERVAL '27 days')::date,
 NULL, 'overdue', NULL,
 890.00, 178.00, 178.00, 1068.00, 0.00, 'overdue',
 'Entretien système - Client à relancer',
 'En cas de retard de paiement, seront exigibles, conformément à l''article L 441-10 du code de commerce, une indemnité calculée sur la base de trois fois le taux de l''intérêt légal en vigueur ainsi qu''une indemnité forfaitaire pour frais de recouvrement de 40 euros. SIRET: 85234567800012 - TVA: FR85234567800 - RCS Paris',
 NOW() - INTERVAL '6 days', NOW() - INTERVAL '5 days'),
('50000000-0000-0000-0004-000000000010', test_user_id, client_10, 'FACT-2025-0010', 'FACT-2025-0010',
 NOW()::date, NOW()::date, (NOW() + INTERVAL '30 days')::date,
 NULL, 'draft', NULL,
 1250.00, 250.00, 250.00, 1500.00, 0.00, 'unpaid',
 'Fourniture matériel',
 'En cas de retard de paiement, seront exigibles, conformément à l''article L 441-10 du code de commerce, une indemnité calculée sur la base de trois fois le taux de l''intérêt légal en vigueur ainsi qu''une indemnité forfaitaire pour frais de recouvrement de 40 euros. SIRET: 85234567800012 - TVA: FR85234567800 - RCS Paris',
